...
function ContactForm() {
  ...
  let [formData2, setFromData2] = useState({ lastName: "uday" })
  let [formData3, setFromData3] = useState({ email: "uday@gmail.com" })
  let [formData4, setFromData4] = useState({ message: "uday hello" })
